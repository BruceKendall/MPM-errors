...
```{r regplots, fig.asp=1, fig.cap='Trends in matrix population model construction errors through time.'}
## Make plots
...
p <- ggplot(mpm_data, aes(YearPublication, as.numeric(!FecCorrect))) + 
  ...
  ylab("Error frequency in reproduction term")

library(ggpubr)
ggarrange(p, p, p, ncol = 1, nrow = 3, labels = "auto", label.x = 0.95)
```
