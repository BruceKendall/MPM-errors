...
Predicting the effects of MPM construction errors on these quantites requires information about the second derivative of $\lambda_1$ with respect to model parameters [@Caswell1996], the theory of which seems to only have been developed for Lefkovitch models. 
...
For the lionfish population, the choice of maturation model had a substantial impact on the eslasticity of $\lambda_1$ to juvenile survival, and the rank order of elasticities to juvenile and adult survival was reversed by the FAS model (Fig. \@ref(fig:lfelasfig)a).
The impacts of of errors in the fertility coefficents had a very modest impact on elasticities \@ref(fig:lfelasfig)a).
