...
However, estimated $\gamma_i$ may be biased if the age-within-stage distribution changes unless it is estimated accounting for the age within stage of individuals. 
We will refer to this as the "observed age-within-stage structure" (OAS) model.

Among AAS, SAS, and FAS models, only the AAS model will replicate $\lambda_1$ and its sensitivities from the fully age-structured model.
