...
*NOTE: The R code used to generate results, tables, and figures is shown in this draft, for transparency of review. It will be hidden in the final version.*
...
This is perfectly sensible, but *most textbooks make this transition without comment.* [CHECK WHAT MILL DOES HERE]
