...
This is potentially confusing, but most practitioners don't move between these models so it is probably not a big issue.
...
```{r matdist, fig.cap="Frequency of approaches for setting maturation rates from stages with mean duration exceeding one timestep. [LGF: use white bars]"}
