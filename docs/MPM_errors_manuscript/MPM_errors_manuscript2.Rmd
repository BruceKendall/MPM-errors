...
abstract: |
  ...
  Of the studies where stages may last longer than one time step, 25% constructed the growth rate using inappropriate formulas for estimating the asymptotic population growth rate or its sensitivity to demographic parameters. 
...
The the bias from FAS model is similar, except that the critical value for $\lambda_1$ is $\sigma_i$. 
...
When the asymptotic growth rate was less than 1, the SAS model also underestimated the adult stable stage distribution (Figure S9) and overestimated the adult reproductive value (Figure S10). 
