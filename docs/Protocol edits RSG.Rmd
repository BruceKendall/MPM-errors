...
IT WOULD BE GOOD TO PROVIDE HERE A GRAPH (E.G. FROM ELLNER'S BOOK ON IPMS) OR A RANGE OF PAGES FROM CASWELL 2001 FOR THE COMPADRINOS TO REVIEW BEFORE DOING THIS TASK
...
I SUPPOSE THAT OPTIONS ARE PROVIDED FOR #6 BELOW...

For each question, record both your response and, in the associated notes field, the evidence supporting your conclusion.
WE SHOULD CREATE AN EXCEL FILE WITH THE VARIABLES ABOVE, FULL CITATION OF THE STUDY, AND NAME OF THE COMPADRINO, AS WELL AS WHETHER IT'S BEEN CHECKED BY YOU OR I.
...
YES, BUT WE COULD ALSO HAVE THE STUDENTS CONTACT THE AUTHOR FOR FURTHER CLARIFICATION. WE DO THIS QUITE FREQUENTLY ANYWAYS.
...
ALSO TO BE ADDED AS A DIFFERENT COLUMN IN THE EXCEL FILE
...
2. **Post**: The youngest class in the matrix is zero timesteps old. Evidence for this includes
    ...
    b. The stage into which the youngest stage matures **next** is unambiguously one timestep old (e.g., "yearling" for a model with an annual timestep). DO YOU AGREE W THIS?
...
IT WOUDL BE GOOD TO PROVIDE PUBLISHED STUDIES IN COMADRE AND IN COMPADRE FOR EACH OF THESE CATEGORIES.
