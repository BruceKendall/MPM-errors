function [tbl]=Alligator3ModelCompS
...
d1=1;
f=5.98;
d2=3;%South stage duration
d3=3;%This was modified from the table to match the results in the paper
...
sens2=[S2(2,1),
    S2(2,2)*(2*sj + 1)/(sj^4 + 2*sj^3 + 3*sj^2 + 2*sj + 1)+...
    S2(3,2)*(sj^4 + 2*sj^3 + 3*sj^2)/(sj^4 + 2*sj^3 + 3*sj^2 + 2*sj + 1),
    S2(3,3)*(2*ss + 1)/(ss^4 + 2*ss^3 + 3*ss^2 + 2*ss + 1)+...
    S2(4,3)*(ss^4 + 2*ss^3 + 3*ss^2)/(ss^4 + 2*ss^3 + 3*ss^2 + 2*ss + 1)+...
    S2(1,3)*((11*f*ss^(7/4))/(4*(ss^2 + ss + 1)) - (f*ss^(11/4)*(2*ss + 1))/(ss^2 + ss + 1)^2)*se,
    S2(4,4)+...
    S2(1,4)*(3*f*se)/(4*sa^(1/4)),
    S2(1,3)*(ss^(11/4)/(ss^2 + ss + 1))*se + ...
    S2(1,4)*sa^(3/4)*se]';
...
sens5=[S5(2,1),
    S5(2,2)*(2*sj + 1)/(sj^4 + 2*sj^3 + 3*sj^2 + 2*sj + 1)+...
    S5(3,2)*(sj^4 + 2*sj^3 + 3*sj^2)/(sj^4 + 2*sj^3 + 3*sj^2 + 2*sj + 1),
    S5(3,3)*(2*ss + 1)/(ss^4 + 2*ss^3 + 3*ss^2 + 2*ss + 1)+...
    S5(4,3)*(ss^4 + 2*ss^3 + 3*ss^2)/(ss^4 + 2*ss^3 + 3*ss^2 + 2*ss + 1),
    S5(4,4)+...
...
sens8=[S8(2,1),
    S8(2,2)*(2*sj + 1)/(sj^4 + 2*sj^3 + 3*sj^2 + 2*sj + 1)+...
    S8(3,2)*(sj^4 + 2*sj^3 + 3*sj^2)/(sj^4 + 2*sj^3 + 3*sj^2 + 2*sj + 1),
    S8(3,3)*(2*ss + 1)/(ss^4 + 2*ss^3 + 3*ss^2 + 2*ss + 1)+...
    S8(4,3)*(ss^4 + 2*ss^3 + 3*ss^2)/(ss^4 + 2*ss^3 + 3*ss^2 + 2*ss + 1),
    S8(4,4),
    S8(1,4)*se]';
...
writetable(tbl,'alligatorSouth.csv')
%
